...
<Image src={printingImage} alt="3D printing printing" class="rounded-lg" />
...
<Image src={modelImage} alt="3D printed LEGO bulldozer" class="rounded-lg" />
...
<Image src={printerImage} alt="Bambu Lab P1S printer" class="rounded-lg" />
...
<Image src={slicingImage} alt="PI helping a person slice their model" class="rounded-lg" />
...
<Image src={processingImage} alt="Post-processing tools" class="rounded-lg" />
...
<Image src={pickupImage} alt="Location of bins to pickup print" class="rounded-lg" />
