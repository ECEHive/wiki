...
<Image src={image} alt="Bambu Lab P1S with 4 AMS units for multi-color printing" class="rounded-lg" />
...
For specifications of the Bambu Lab P1S, please refer to the [Bambu Lab P1S page](/wiki/3d-printing/10-bbl-p1s).
