...
- [Electronics Benchtop](/explore/electronics-benchtop)
- [3D Printing](/explore/3d-printing)
- [Laser Cutting](/explore/laser-cutting)
- [Embedded Systems](/explore/embedded-systems)
- [PCB Fabrication](/explore/pcb)
- [Machine Shop](/explore/machine-shop)
- [Crafts](/explore/crafts)
...
Every semester, we host a variety of workshops across our different technical areas. Please see the sidebar section labeled "Workshop Docs" for documentation on past workshops. As of Fall 2025, these pages are actively being edited. One big goal is to make it so anyone can go through the steps of the workshop, even if they weren't able to attend the workshop itself!

For information on upcoming workshops, look for an announcement from the Hive's mailing list or visit the events calendar on [the Hive's website](https://hive.ece.gatech.edu/).

## Editing this Wiki

There are links to edit at the bottom of each individual page. You may create a fork and submit a pull request if you wish.
