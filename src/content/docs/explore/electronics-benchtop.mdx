...
In addition we also have video demoes listed for all of these different pieces of equipment found here: 

import YouTubeGrid from '/src/components/youtube-grid.astro';


{/* Redesign component to auto-populate from playlist link https://www.youtube.com/playlist?list=PLaHV-4SxpcHx4nsOkHsaOwHsnmBU3wZ4W */}
