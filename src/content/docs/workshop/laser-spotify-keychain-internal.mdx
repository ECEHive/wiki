...
<figure>
    <Image class="border-2 border-slate-200 rounded-lg" src={img1} alt="A stained glass design made via laser cutting and resin pouring." height="300"/>
...
Volunteers requested:  3 vUsually in stock.olunteers, familiar with laser cutting and illustrator. Each volunteer can help two paris
