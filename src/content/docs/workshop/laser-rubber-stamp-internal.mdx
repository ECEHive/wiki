...
| Ink pads (colors) | Craft ink pads to use for stamps | 1 pack of 20 | [Primary](https://www.amazon.com/YPSelected-Inkpad-Fabric-Available-Multi-Colors/dp/B08R377414/), [Alternate](https://www.amazon.com/Lsushine-Craft-Stamps-Partner-Fabric/dp/B01CKXUCNE/) |
...
- 10 min: introductions of workshop leads, introduction to the hive
- 10 min: Intro to the materials/tools we’ll be using (lasercutting/machineshop)
- 20 min: Adobe Illustrator walkthrough presentation (while they can also get started on their own design)
- 30 min: Work time! Make your design!
- 40 min: laser cutting stamp design, making blocks for the backing, handing out ink pads
