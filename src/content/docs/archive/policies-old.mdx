...
import img1 from '../../../assets/policies-main-img1.png';

{/* TODO: Maybe add changelog */}

:::caution
This page has been archived and is no longer being updated. See https://hive.ece.gatech.edu/rules-and-policies/ for the most up-to-date version.
:::
...
<dl class="pol">
    ...
    <dd class="pol-1">
        ...
        <Image src={img1} alt="Map of The Hive Makerspace, First Floor" width="300" />
    </dd>
</dl>
...
<dl class="pol">
    ...
    <dd class="pol-2">PIs may permanently swap their shifts with other PIs if both parties agree and Staff have given their approval.</dd>
