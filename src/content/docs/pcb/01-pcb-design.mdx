...
- KiCAD Tutorials by out own MPI, Ben H: [PCB Design with KiCAD](https://www.youtube.com/playlist?list=PLaHV-4SxpcHyxIewNGTkg91Whu2T2Rbzt) (YouTube) - an 11-part video series based on a 3-hour workshop that covers PCB design using KiCAD to develop circuit boards from start to finish, plus four videos about library and model creation and management.
    - PDFs: [All Parts](/pcb-kicadwkshp-2024-all.pdf)
        - [Part 0 (Intro)](/pcb-kicadwkshp-2024-p0-intro.pdf)
        - [Part 1 (PCB basics)](/pcb-kicadwkshp-2024-p1-pcbbasics.pdf)
        - [Part 2 (Design basics)](/pcb-kicadwkshp-2024-p2-designoverview.pdf)
        - [Part 3 (Circuit and part selection)](/pcb-kicadwkshp-2024-p3-partselection.pdf)
        - [Part 4A (Adding symbols to the schematic)](/pcb-kicadwkshp-2024-p4a-schematicpartaddition.pdf), [Part 4B (Symbol creation)](/pcb-kicadwkshp-2024-p4b-schematicsymbolcreation.pdf), [Part 4C (Schematic wiring)](/pcb-kicadwkshp-2024-p4c-schematicwiring.pdf), [Part 4D (Footprint assignment)](/pcb-kicadwkshp-2024-p4d-schematicfootprints.pdf), [Part 4E (ERC)](/pcb-kicadwkshp-2024-p4e-schematicerc.pdf)
        - [Part 5A (PCB editor/layout setup)](/pcb-kicadwkshp-2024-p5a-boardsetup.pdf), [Part 5B (Footprint placement and routing)](/pcb-kicadwkshp-2024-p5b-layoutplacementrouting.pdf), [Part 5C (Final layout checks and DRC)](/pcb-kicadwkshp-2024-p5c-layoutprefabchecks.pdf)
        - [Part 6 (Symbol library management)](/pcb-kicadwkshp-2024-p6-symbollib.pdf)
        - [Part 7A (Footprint library management)](/pcb-kicadwkshp-2024-p7a-footprintlibcreationcopy.pdf), [Part 7B (Footprint generation from scratch)](/pcb-kicadwkshp-2024-p7b-footprintlibblankcanvas.pdf), [Part 7C (Footprint generation with the wizard)](/pcb-kicadwkshp-2024-p7c-footprintlibwizard.pdf)
- SparkFun's Eagle tutorials: [Better PCBs In Eagle](https://www.sparkfun.com/tutorials/115)
- An old Eagle walk through by our own PCB MPI, Ben H: [How To Eagle (PDF)](/pcb-howtoeagle.pdf)
...
- An Altium walkthrough, by PI Emily Marshall:
    - Part 1 ([PDF guide](/pcb-altiumwkshp-p1-guide.pdf), [PDF slides](pcb-altiumwkshp-p1-slides.pdf))
    - Part 2 ([PDF guide](/pcb-altiumwkshp-p2-guide.pdf), [PDF slides](/pcb-altiumwkshp-p2-slides.pdf))
    - [Custom Altium library](/pcb-altiumwkshp-library.IntLib)
