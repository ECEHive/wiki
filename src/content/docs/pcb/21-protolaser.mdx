...
The Manual: [ProtoLaser U4 User Manual (PDF)](/pcb-protolaser-u4-usermanual.pdf)

LPKF's "How-To" guides: [ProtoLaser U4 How To Guides (PDF)](/pcb-protolaser-u4-howto.pdf)

Software guide: [CircuitPro 3.0 PL - Software Guide (PDF)](/pcb-circuitpro-3-0-pl-softwareguide.pdf)

Vacuum system manual: [Dust Extraction Manual CSA 600 iSeries-e-1-0 (PDF)](/pcb-dustextraction-manual-csa600-iseries-e-1-0.pdf)

Optimizing your process: [Protolaser - Optimization (PDF)](/pcb-protolaser-optimization.pdf)
...
So you're running a [single-sided laser-only process](/pcb/11-pcb-processes#single-sided-no-holes), and you'd like to adjust the breakout tabs. No problem! It's very straightforward to do, and you can do it before or after the toolpath has been generated.
