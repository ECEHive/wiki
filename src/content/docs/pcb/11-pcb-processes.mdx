...
### ProtoMat - The board outline in the Machining view is a lot larger than my board!

Sometimes the CircuitPro software inserts a fifth fiducial into your design when it is saved to a file. To fix this issue, delete the fifth fiducial and re-compute toolpaths.
...
Please check out our [Knowledge Base](/explore/pcb) for additional Q&As, tips, tricks, and solutions to common processing errors.

- For issues with the ProtoMat, see the [ProtoMat Knowledge Base](/pcb/20-protomat/).
- For issues with the ProtoLaser, see the [ProtoLaser Knowledge Base](/pcb/21-protolaser/).
