...
The Manual: [ProtoMat S-series Manual (PDF)](/pcb-protomat-s-manual.pdf)
...
The ProtoMat software ("CircuitPro") compendium: [CircuitPro 2.3 Compendium (PDF)](/pcb-circuitpro-2-3-compendium.pdf)

The vacuum system manual: [Dust Extraction Manual Jet Stream iSeries-e-1-0 (PDF)](/pcb-dustextraction-manual-jetstream-iseries-e-1-0.pdf)
...
The LPKF sofware handles drill hits down to 0.2mm (7.5 mil) without any adjustments, but we have the capability to make 0.15mm (5.6 mil) drill hits as well with slightly more effort. See our [0.15mm Drill Hits](/pcb/20-protomat/#guide-making-015-mm-drill-hits) section for details on that.
