...
1. [Single sided design, no holes](/wiki/pcb/11-pcb-processes#single-sided-no-holes), no plating.
2. [Single sided design, with holes](/wiki/pcb/11-pcb-processes#single-sided-with-holes), no plating.
3. [Double sided, no plating](/wiki/pcb/11-pcb-processes#double-sided-no-plating), regardless of hole count.
4. [Solderpaste stencils](/wiki/pcb/31-stencilnreflow#how-to-make-and-use-stencils)
5. [Reflow oven](/wiki/pcb/31-stencilnreflow#how-to-use-the-reflow-oven)
6. [Kapton tape soldermasking](/wiki/pcb/30-masknsilkscreen/#soldermasking-with-kapton-tape) (unverified)
