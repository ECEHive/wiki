...
1. [Single sided design, no holes](/pcb/11-pcb-processes#single-sided-no-holes), no plating.
2. [Single sided design, with holes](/pcb/11-pcb-processes#single-sided-with-holes), no plating.
3. [Double sided, no plating](/pcb/11-pcb-processes#double-sided-no-plating), regardless of hole count.
4. [Solderpaste stencils](/pcb/31-stencilnreflow#how-to-make-and-use-stencils)
5. [Reflow oven](/pcb/31-stencilnreflow#how-to-use-the-reflow-oven)
6. [Kapton tape soldermasking](/pcb/30-masknsilkscreen/#soldermasking-with-kapton-tape) (unverified)

**HELP!** –> First, go to the proper process guide and make sure you've followed our most up-to-date process. If that doesn't resolve the issue, see the relevant tool pages ([Protomat](/pcb/20-protomat/), [Protolaser](/pcb/21-protolaser/)) for additional details.

See our [tips and tricks](/pcb/40-pcb-advanced/) page for some advanced processing concepts (or just interesting tidbits).
...
- *Substrates*: FR4, Rogers materials, polyamide, among many others. See the [ProtoLaser help page](/pcb/21-protolaser/) for more details.
- *Copper thickness/weight*: No known limit, other than processing time.
- *Slot*: yes, but YMMV. See our [fabs tips](/pcb/40-pcb-advanced/) page for details.
- *Soldermask*: we have the chemicals, which have an official process, but we don't officially support it. See the ProMask datasheet, below. We also have trialed an alternative masking process with Kapton tape, but YMMV. See [this page](/pcb/30-masknsilkscreen/#soldermasking-with-kapton-tape) for more details.
...
- *Stencils*: we can make them! See our "[How to make stencils](/pcb/31-stencilnreflow#how-to-make-and-use-stencils)" page for more!
- *Reflow*: we have a fully operational reflow oven, optimized for lead-free solder paste. See "[How to reflow](/pcb/31-stencilnreflow#how-to-use-the-reflow-oven)" for more information.
...
- LPKF ProtoMat S103 ([datasheet](https://www.lpkfusa.com/datasheets/prototyping/s103.pdf), [SOP](https://gtvault.sharepoint.com/:w:/s/HiveMakerspace/EcQvNGoNNa5AjiZ5wU1Vd8wBMPNk8mawFspeLrvNaG8VlQ?e=yWBkGg), [help page](/pcb/20-protomat/)) - drilling, milling, and routing
- LPKF ProtoLaser U4 ([datasheet](https://www.lpkf.com/fileadmin/mediafiles/user_upload/products/pdf/DQ/brochure_lpkf_protolaser_u4_en.pdf), SOP, [help page](/pcb/21-protolaser/)) - etching, cutting
...
- LPKF ProtoPrint S ([datasheet](https://www.lpkfusa.com/datasheets/prototyping/zelprint.pdf), [How-to](/pcb/31-stencilnreflow#how-to-make-and-use-stencils), SOP) - Solderpaste stencil holder
- LPKF ProtoFlow ([datasheet](https://www.lpkfusa.com/datasheets/prototyping/protoflow.pdf), [How-to](/pcb/31-stencilnreflow#how-to-use-the-reflow-oven), SOP) - Reflow oven
...
If you’re board passes OshPark’s specs ([OshPark .dru file](https://docs.oshpark.com/design-tools/eagle/design-rules-files)), it can be made using our process (see their website for details). However, our process can, in fact, go beyond that in some ways. See our equipment knowledge bases ([Protomat](/pcb/20-protomat/), [Protolaser](/pcb/21-protolaser/)) and [Tips and Tricks](/pcb/40-pcb-advanced/) pages for additional information.
...
**Note**: If you're considering a design at our theoretical minimum capabilities, first strongly consider whether you need that level of precision. If the answer is still yes, go to the [ProtoLaser](/pcb/21-protolaser/) (for etching) and [ProtoMat](/pcb/20-protomat/) (for drilling) help sections for advice on reaching those new lows.
...
Yes!
1. [DRC](/pcb-hive-minimum.dru)
2. [CAM](/pcb-hive-basic.cam)
...
It depends on the size and layout of your board. A small board with no electroplating can easily be made in under an hour, while a very large board with lots of copper removed can take over 4 hours.
...
For those who would like to attempt this, instructions are available on our [mask and silkscreen](/pcb/30-masknsilkscreen/) page, as well as in the "Manuals/Instructions" drawer next to the tools themselves.

We ALSO have an alternative process to use Kapton tape to make a soldermask-like covering on your board. Definite a YMMV-situation, but [the instructions are here](/pcb/30-masknsilkscreen/#soldermasking-with-kapton-tape).
...
Many! See the relevant tool pages ([Protomat](/pcb/20-protomat/), [Protolaser](/pcb/21-protolaser/)) and [Tips, tricks, and process miscellany](/pcb/40-pcb-advanced/) pages for these, as they're often listed in various bits of documentation that would be out of place on this page.
