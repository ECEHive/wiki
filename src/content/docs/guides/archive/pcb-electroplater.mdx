...
The LPKF Datasheet for the Contac S4: [Contac S4-v1-0-en (PDF)](/pcb-contac-s4-v1.pdf), [Flyer](https://www.lpkf.com/fileadmin/mediafiles/user_upload/products/pdf/DQ/flyer_lpkf_contac_s4_en.pdf)

The [Material] Safety Data Sheets (MSDS/SDS): [LPKD_SDS (PDF)](/pcb-lpkf-sds.pdf)
