...
Nope! However, if you are unfamiliar with PCBs, we recommend [reading up on some basics](/guides/pcb-basics/) on the internet before watching. This way, the videos will (might?) make more sense.
...
Schedule another checkoff following the same procedure. It is strongly recommended that you rewatch the training videos or read up on the fabrication process on the Wiki on our [PCB Fabrication](/pcb/10-pcb-fab/) page.
