...
1. [Single sided design, no holes](/wiki/guides/pcb-processes#single-sided-no-holes), regardless of plating.
2. [Single sided design, with holes](/wiki/guides/pcb-processes#single-sided-with-holes), regardless of plating.
3. [Double sided, no plating](/wiki/guides/pcb-processes#double-sided-no-plating), regardless of hole count.
4. [Double sided, with plating](/wiki/guides/pcb-processes#double-sided-with-plating), regardless of hole count.
5. [Solderpaste stencils](/wiki/guides/pcb-stencilnreflow#how-to-make-and-use-stencils)
6. [Reflow oven](/wiki/guides/pcb-stencilnreflow#how-to-use-the-reflow-oven)
7. [Kapton tape soldermasking](/wiki/guides/pcb-masknsilkscreen/#soldermasking-with-kapton-tape) (unverified)

**HELP!** –> First, go to the proper process guide and make sure you've followed our most up-to-date process. If that doesn't resolve the issue, see the [Knowledge Base](/wiki/explore/pcb#pcb-knowledge-base-and-faq) for processing issues/concerns/questions.

See our [tips and tricks](/wiki/explore/pcb#miscellaneous-processing-tips) page for some advanced processing concepts (or just interesting tidbits).
...
- *Substrate*s: FR4, Rogers materials, polyamide, among many others. See the [ProtoLaser help page](/wiki/guides/pcb-protolaser/) for more details.
- *Copper thickness/weight*: No known limit, other than processing time.
- *Slot*: yes, but YMMV. See our [fabs tips](/wiki/explore/pcb#miscellaneous-processing-tips) page for details.
- *Electroplating*: yes, standard processing time of 3 hours will plate approximately 16 um of copper. We also have a chemical-free non-electrical “plating” process with the ProConduct package. See our [electroplater help page](/wiki/guides/pcb-electroplater/) for details.
- *Soldermask*: we have the chemicals, which have an official process, but we don't officially support it. See the ProMask datasheet, below. We also have trialed an alternative masking process with Kapton tape, but YMMV. See [this page](/wiki/guides/pcb-masknsilkscreen/#soldermasking-with-kapton-tape) for more details.
...
- *Stencils*: we can make them! See our “[How to make stencils](/wiki/guides/pcb-stencilnreflow#how-to-make-and-use-stencils)” page for more!
- *Reflow*: we have a fully operational reflow oven, optimized for lead-free solder paste. See “[How to reflow](/wiki/guides/pcb-stencilnreflow#how-to-use-the-reflow-oven)” for more information.
- Our [knowledge base](/wiki/explore/pcb#pcb-knowledge-base-and-faq) is pretty extensive as well, so check that for answers to many questions and processing help.

The full suit includes the following:

- LPKF ProtoMat S103 ([datasheet](https://www.lpkfusa.com/datasheets/prototyping/s103.pdf), [SOP](https://gtvault.sharepoint.com/:w:/s/HiveMakerspace/EcQvNGoNNa5AjiZ5wU1Vd8wBMPNk8mawFspeLrvNaG8VlQ?e=yWBkGg), [help page](/wiki/guides/pcb-protomat/)) - drilling, milling, and routing
- LPKF ProtoLaser U4 ([datasheet](https://www.lpkf.com/fileadmin/mediafiles/user_upload/products/pdf/DQ/brochure_lpkf_protolaser_u4_en.pdf), SOP, [help page](/wiki/guides/pcb-protolaser/)) - etching, cutting
- LPKF Contac S4 ([datasheet](https://www.lpkf.com/fileadmin/mediafiles/user_upload/products/pdf/DQ/flyer_lpkf_contac_s4_en.pdf), SOP, [help page](/wiki/guides/pcb-electroplater/)) - electroplating
...
- LPKF ProtoPrint S ([datasheet](https://www.lpkfusa.com/datasheets/prototyping/zelprint.pdf), [How-to](/wiki/guides/pcb-stencilnreflow#how-to-make-and-use-stencils), SOP) - Solderpaste stencil holder
- LPKF ProtoFlow ([datasheet](https://www.lpkfusa.com/datasheets/prototyping/protoflow.pdf), [How-to](/wiki/guides/pcb-stencilnreflow#how-to-use-the-reflow-oven), SOP) - Reflow oven
...
**Note**: If you're considering a design at our theoretical minimum capabilities, first strongly consider whether you need that level of precision. If the answer is still yes, go to the [ProtoLaser](/wiki/guides/pcb-protolaser/) (for etching) and [ProtoMat](/wiki/guides/pcb-protomat/) (for drilling) help sections for advice on reaching those new lows.
...
For those who would like to attempt this, instructions are available on our [mask and silkscreen](/wiki/guides/pcb-masknsilkscreen/) page, as well as in the “Manuals/Instructions” drawer next to the tools themselves.

We ALSO have an alternative process to use Kapton tape to make a soldermask-like covering on your board. Definite a YMMV-situation, but [the instructions are here](/wiki/guides/pcb-masknsilkscreen/#soldermasking-with-kapton-tape).
