...
Once you've placed all your components, you can reflow the board to melt all the solder in place at once. See our ”[How to reflow](/wiki/guides/pcb-stencilnreflow#how-to-use-the-reflow-oven)“ page for how to use the reflow oven. 
