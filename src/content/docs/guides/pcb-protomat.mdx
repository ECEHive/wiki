...
The LPKF sofware handles drill hits down to 0.2mm (7.5 mil) without any adjustments, but we have the capability to make 0.15mm (5.6 mil) drill hits as well with slightly more effort. See our [0.15mm Drill Hits](/wiki/guides/pcb-protomat/#guide-making-015-mm-drill-hits) section for details on that.
