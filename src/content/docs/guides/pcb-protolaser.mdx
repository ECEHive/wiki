...
So you're running a [single-sided laser-only process](/hive-wiki/guides/pcb-processes#single-sided-no-holes), and you'd like to adjust the breakout tabs. No problem! It's very straightforward to do, and you can do it before or after the toolpath has been generated.
