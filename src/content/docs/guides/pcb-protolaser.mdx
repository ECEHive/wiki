...
Adjusting the breakout tabs If you're running a single-sided laser-only process, you can adjust the breakout tabs that connect the board to the substrate, both their position and size. See “[Adjusting Breakout Tabs on the Laser](/wiki/guides/pcb-protolaser/#guide-how-to-adjust-the-breakout-tabs-on-the-laser)” for details. 
...
So you're running a [single-sided laser-only process](/wiki/guides/pcb-processes#single-sided-no-holes), and you'd like to adjust the breakout tabs. No problem! It's very straightforward to do, and you can do it before or after the toolpath has been generated.
