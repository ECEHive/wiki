...
11. Under “Material type”:
    ...
    3. If you are really keen on using this, I would recommend creating your own material and developing that process. See our [ProtoLaser: New Material](https://gtvault.sharepoint.com/:w:/s/HiveMakerspace/EShrwNPAMH1Cj3cE3pg5h8QB6r3JP-XtLghmQcU96-fNfA?e=Ska4Ud) document for how to do this, and LPKF's [Protolaser - Optimization.pdf](https://gtvault.sharepoint.com/:b:/s/HiveMakerspace/EZGQyfhrC0BItpbSxd_rjRQBzDyNWUubu-RCuJr6a3OI9A?e=nbVu4k) document for optimization.
