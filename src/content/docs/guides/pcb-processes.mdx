...
Please check out our [Knowledge Base](/wiki/explore/pcb#pcb-knowledge-base-and-faq) for additional Q&As, tips, tricks, and solutions to common processing errors.
...
Note that as of Fall 2022, the electroplater is a separate tool that requires a separate training sequence. Please check our [Training](https://wiki.hive.ece.gatech.edu/doku.php?id=pcb-training) page for details.
...
**Step 2**: [Electroplating with the Contac S4](https://gtvault.sharepoint.com/:w:/s/HiveMakerspace/ESv_zF8waMZDucEP3-J6NFYBuArRkl8M5vwusDOW_0RiDQ?e=IUuxvH)
...
For issues with the ProtoMat, see the [ProtoMat Knowledge Base](/wiki/guides/pcb-protomat/).

For issues with the ProtoLaser, see the [ProtoLaser Knowledge Base](/wiki/guides/pcb-protolaser/).

For issues with the electroplater, see the [Contact S4 Knowledge Base](/wiki/guides/pcb-electroplater/).
